...
import org.hermitsocialclub.tomato.NativeTestPipelineComponent
import org.openftc.easyopencv.OpenCvCamera

@TeleOp(name = "TomatoVisionTestOp")
class TomatoVisionTestOp : AbstractVisionTestOp() {
    override fun buildPipeline(telemetry: PersistantTelemetry): VisionPipeline {
        return VisionPipeline(hardwareMap, telemetry, NativeTestPipelineComponent)
    }
