...
public class DriveConstants {
     ...
     * empirically tuned.
     */
    public static double kV = 0.01926780108101678;//1.0 / rpmToVelocity(MAX_RPM);//0.01587;//0.0135;//
    public static double kA = 0.003;//0.00001;
    public static double kStatic = 0.025;//0.06619;//.05425;
