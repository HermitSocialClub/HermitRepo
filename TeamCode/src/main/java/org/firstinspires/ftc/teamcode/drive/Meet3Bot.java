...
public class Meet3Bot extends DriveConstants {
     ...
     */
    public static double WHEEL_RADIUS_IMPL = 3;
    public static double GEAR_RATIO_IMPL = 1; // output (wheel) speed / input (motor) speed
    public static double TRACK_WIDTH_IMPL = 16.3;
    public static double WHEEL_BASE_IMPL = 16.5;
    ...
    public static double MAX_ANG_VELO_IMPL = 6;
    public static double MAX_ANG_ACCEL_IMPL = Math.toRadians(180);

    public static double kV_IMPL = 0.011962055475993843;//0.03025;//0.018067801;//.016667801;//1.0 / rpmToVelocity(MAX_RPM);//0.01926780108101678;////0.01587;//0.0135;//
    public static double kA_IMPL = 0.0026;//0.004;//0.0045;//0.003;//0.003;//0.00001;
    public static double kStatic_IMPL = 0.01;//0.03;//0.003;//0.02;//0.025;//0.06619;//.05425;
